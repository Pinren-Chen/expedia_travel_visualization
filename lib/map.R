...
p3 <- plot_geo(state.count1, locationmode = 'USA-states', sizes = c(1, 250)) %>%
  add_markers(
...
p1<-eWordcloud(dat1, namevar = ~name, datavar = ~number,size = c(600, 600),title = "summer & Torridzone",rotationRange = c(-20, 20))
p2<-eWordcloud(dat2, namevar = ~name, datavar = ~number,size = c(600, 600),title = "fall & temperate",rotationRange = c(-20, 20))
